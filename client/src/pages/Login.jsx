   ...
   return (
    ...
    <form onSubmit={onSubmit} style={{ border: "1px solid #ccc", padding: "20px", borderRadius: "5px", boxShadow: "0 2px 5px rgba(0, 0, 0, 0.1)", backgroundColor: "#f9f9f9" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
            <button type="submit" style={{ backgroundColor: "green", color: "white", padding: "8px 15px", borderRadius: "3px", border: "none", cursor: "pointer" }}>Signup</button>
        </div>

        <span style={{ display: "block", textAlign: "center", marginTop: "20px" }}>Already have any account? <Link to={"/"}>Login</Link></span>
    </form>
</div>
